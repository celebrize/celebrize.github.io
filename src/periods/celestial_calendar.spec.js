...
describe('lunar month span', () => {
    test('can add one lunar month', () => {
        ...
        const real = lunarMonths.getDate(now, 1)
        const deviation = 1
    ...
    test('can add a huge amount of lunar months', () => {
        ...
        const real = lunarMonths.getDate(now, 1000)
        const deviation = 600
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('lunar month span', () => {
    test('can add one lunar orbit', () => {
        ...
        const real = lunarOrbits.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of lunar orbits', () => {
        ...
        const real = lunarOrbits.getDate(now, 1000)
        const deviation = 600
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('mercury day span', () => {
    test('can add one mercury day', () => {
        ...
        const real = mercuryDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mercury days', () => {
        ...
        const real = mercuryDays.getDate(now, 200)
        const deviation = 200
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('mercury year span', () => {
    test('can add one mercury year', () => {
        ...
        const real = mercuryYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mercury years', () => {
        ...
        const real = mercuryYears.getDate(now, 500)
        const deviation = 500
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('venus day span', () => {
    test('can add one venus day', () => {
        ...
        const real = venusDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of venus days', () => {
        ...
        const real = venusDays.getDate(now, 500)
        const deviation = 500
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('venus year span', () => {
    test('can add one venus year', () => {
        ...
        const real = venusYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of venus years', () => {
        ...
        const real = venusYears.getDate(now, 200)
        const deviation = 200
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('mars day span', () => {
    test('can add one mars day', () => {
        ...
        const real = marsDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mars days', () => {
        ...
        const real = marsDays.getDate(now, 50000)
...
describe('mars year span', () => {
    test('can add one mars year', () => {
        ...
        const real = marsYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mars years', () => {
        ...
        const real = marsYears.getDate(now, 100)
        const deviation = 100
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('jupiter day span', () => {
    test('can add one jupiter day', () => {
        ...
        const real = jupiterDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of jupiter days', () => {
        ...
        const real = jupiterDays.getDate(now, 100000)
...
describe('jupiter year span', () => {
    test('can add one jupiter year', () => {
        ...
        const real = jupiterYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('saturn day span', () => {
    test('can add one saturn day', () => {
        ...
        const real = saturnDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of saturn days', () => {
        ...
        const real = saturnDays.getDate(now, 100000)
        const deviation = 100000
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('saturn year span', () => {
    test('can add one saturn year', () => {
        ...
        const real = saturnYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('uranus day span', () => {
    test('can add one uranus day', () => {
        ...
        const real = uranusDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of uranus days', () => {
        ...
        const real = uranusDays.getDate(now, 100000)
        const deviation = 100000
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('uranus year span', () => {
    test('can add one uranus year', () => {
        ...
        const real = uranusYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('neptune day span', () => {
    test('can add one neptune day', () => {
        ...
        const real = neptuneDays.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of neptune days', () => {
        ...
        const real = neptuneDays.getDate(now, 100000)
        const deviation = 100000
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('neptune year span', () => {
    test('can add one neptune year', () => {
        ...
        const real = neptuneYears.getDate(now, 1)
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
//         const real = mercuryRotations.getDate(now, 1)
//         const deviation = 1
//         const min = new Date(expected)
//         min.setSeconds(min.getSeconds() - deviation)
//         const max = new Date(expected)
...
//         const real = mercuryRotations.getDate(now, 1000)
