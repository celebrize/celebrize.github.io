...
describe('lunar month span', () => {
    test('can add one lunar month', () => {
        ...
        const real = lunarMonths.generateDate(now, 1).getDate()
        const deviation = 1
    ...
    test('can add a huge amount of lunar months', () => {
        ...
        const real = lunarMonths.generateDate(now, 1000).getDate()
        const deviation = 600
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('lunar month span', () => {
    test('can add one lunar orbit', () => {
        ...
        const real = lunarOrbits.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of lunar orbits', () => {
        ...
        const real = lunarOrbits.generateDate(now, 1000).getDate()
        const deviation = 600
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('mercury day span', () => {
    test('can add one mercury day', () => {
        ...
        const real = mercuryDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mercury days', () => {
        ...
        const real = mercuryDays.generateDate(now, 200).getDate()
        const deviation = 200
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('mercury year span', () => {
    test('can add one mercury year', () => {
        ...
        const real = mercuryYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mercury years', () => {
        ...
        const real = mercuryYears.generateDate(now, 500).getDate()
        const deviation = 500
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('venus day span', () => {
    test('can add one venus day', () => {
        ...
        const real = venusDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of venus days', () => {
        ...
        const real = venusDays.generateDate(now, 500).getDate()
        const deviation = 500
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('venus year span', () => {
    test('can add one venus year', () => {
        ...
        const real = venusYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of venus years', () => {
        ...
        const real = venusYears.generateDate(now, 200).getDate()
        const deviation = 200
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('mars day span', () => {
    test('can add one mars day', () => {
        ...
        const real = marsDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mars days', () => {
        ...
        const real = marsDays.generateDate(now, 50000).getDate()
...
describe('mars year span', () => {
    test('can add one mars year', () => {
        ...
        const real = marsYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of mars years', () => {
        ...
        const real = marsYears.generateDate(now, 100).getDate()
        const deviation = 100
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('jupiter day span', () => {
    test('can add one jupiter day', () => {
        ...
        const real = jupiterDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of jupiter days', () => {
        ...
        const real = jupiterDays.generateDate(now, 100000).getDate()
...
describe('jupiter year span', () => {
    test('can add one jupiter year', () => {
        ...
        const real = jupiterYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('saturn day span', () => {
    test('can add one saturn day', () => {
        ...
        const real = saturnDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of saturn days', () => {
        ...
        const real = saturnDays.generateDate(now, 100000).getDate()
        const deviation = 100000
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('saturn year span', () => {
    test('can add one saturn year', () => {
        ...
        const real = saturnYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('uranus day span', () => {
    test('can add one uranus day', () => {
        ...
        const real = uranusDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of uranus days', () => {
        ...
        const real = uranusDays.generateDate(now, 100000).getDate()
        const deviation = 100000
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('uranus year span', () => {
    test('can add one uranus year', () => {
        ...
        const real = uranusYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('neptune day span', () => {
    test('can add one neptune day', () => {
        ...
        const real = neptuneDays.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
    ...
    test('can add a huge amount of neptune days', () => {
        ...
        const real = neptuneDays.generateDate(now, 100000).getDate()
        const deviation = 100000
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
describe('neptune year span', () => {
    test('can add one neptune year', () => {
        ...
        const real = neptuneYears.generateDate(now, 1).getDate()
        const deviation = 1
        const min = new Date(expected)
        min.setSeconds(min.getSeconds() - deviation)
        const max = new Date(expected)
...
//         const real = mercuryRotations.generateDate(now, 1).getDate()
//         const deviation = 1
//         const min = new Date(expected)
//         min.setSeconds(min.getSeconds() - deviation)
//         const max = new Date(expected)
...
//         const real = mercuryRotations.generateDate(now, 1000).getDate()
